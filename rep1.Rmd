...
#Dummies M&A's;
csur98$duacq <- ifelse(csur98$acqui==1,1,0)
csur98$dusco<- ifelse(csur98$scorpo==1,1,0)
...
csur01$quoimm <- csur01$imte/(csur01$aco+csur01$aim)
	#Log of Sales
csur01$lsales <- log(csur01$sales)
...
```{r, cache = TRUE}
merge1$persist <- ifelse((merge1$raz92d==1&merge1$raz95d==1), 1,ifelse((is.na(merge1$raz95d)&is.na(merge1$raz92d)),0,0))
