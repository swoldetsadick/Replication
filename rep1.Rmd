...
csur92$duofut <- as.factor(ifelse(csur92$ofut > csur92$pofut & csur92$ofut != ".",1,ifelse(csur92$ofut==".",".",0)))
csur92$dimm <- as.factor(ifelse(csur92$quoimm < csur92$pquoimm & csur92$pquoimm != ".",1,ifelse(csur92$ofut==".",".",0)))
...
```{r, cache = TRUE}
#Dummies M&A's;
csur95$duacq <- ifelse(csur95$acqui==1,1,0)
csur95$dusco <- ifelse(csur95$scorpo==1,1,0)
```
...
csur95$durg <- ifelse(csur95$isgru==1,1,0)
```
...
csur95$quoimm <- csur95$imte/(csur95$aco + csur95$aim)
	#Log of Sales
csur95$lsales <- log(csur95$sales)
