...
merge1$eta92c <- ifelse((is.na(merge1$eta92)|merge1$eta92<0) & (!is.na(merge1$eta95) ) & (is.na(merge1$eta95) & is.na(merge1$raz95d))|(is.na(merge1$eta92)&is.na(merge1$raz92d)), merge1$eta95 - 3, merge1$eta92)
merge1$eta95c <- ifelse((is.na(merge1$eta95)|merge1$eta95<0) & (!is.na(merge1$eta92) ) & (is.na(merge1$eta95) & is.na(merge1$raz95d))|(is.na(merge1$eta92)&is.na(merge1$raz92d)), merge1$eta92 + 3, merge1$eta95)    
...
merge1$eta95c <- ifelse((merge1$deta == 2 | merge1$deta == 4), merge1$eta92c + 3, merge1$eta95c)
...
#temp9295 <- subset(temp9295,!is.na(eta92c) & !is.na(eta95c))
